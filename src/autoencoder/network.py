...
class AutoEncoder:
	...
	def contruct_network(self):
		self.encoder_1W = tf.Variable(tf.truncated_normal([self.dim[0]*self.dim[1],int(self.dim[0]*self.dim[1]/2)]))
		self.encoder_1b = tf.Variable(tf.truncated_normal([int(self.dim[0]*self.dim[1]/2)]))
		self.encoder_2W = tf.Variable(tf.truncated_normal([int(self.dim[0]*self.dim[1]/2),int(self.dim[0]*self.dim[1]/4)]))
		self.encoder_2b = tf.Variable(tf.truncated_normal([int(self.dim[0]*self.dim[1]/4)]))
